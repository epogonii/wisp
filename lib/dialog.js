...
class WaitBar extends St.Widget {
     ...
     *
     * The width is set on the stripe rather than handed to it as a box. A box
     * is what the layout would have given it anyway, and the layout gives an
     * actor aligned to the start its own preferred width - which for an empty
     * widget is nothing at all. A width it is asked for is a width it prefers.
     * Which is why this waits for an idle rather than running where the
     * allocation is announced; see _queue.
     */
    _measure() {
