...
// The file polkit itself ships its actions in. The exec action has no file of
// its own: it is defined here, next to lockdown. Only whether the file is there
// is asked, since reading it would be a read the shell sits and waits on.
const ACTION_FILE = '/usr/share/polkit-1/actions/org.freedesktop.policykit.policy';
